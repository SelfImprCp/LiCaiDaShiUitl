...
public class StatusBarU {
    ...
    public StatusBarU(Activity activity) {
        mActivity = activity;
    }

    public static StatusBarU with(Activity activity) {
        return new StatusBarU(activity);
    }
    ...
    public StatusBarU setColor(int color) {
        mColor = color;
        return this;
    }
    ...
    public StatusBarU setDrawable(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public StatusBarU setIsActionBar(boolean actionBar) {
     ...
     * @return
     */
    public StatusBarU setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
     ...
     * 去除 ActionBar 阴影
     */
    public StatusBarU clearActionBarShadow() {

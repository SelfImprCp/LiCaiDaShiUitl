 ...
 */
public class XRefreshListViewSize10Fragment<T extends MyEntity> extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
...
//        } else {
        ...
        //   requestData();
        // }
        LogCp.i(LogCp.CP, XRefreshListViewSize10Fragment.class + "  设置缓存的ke   " + myCachePath);


        String cacheStr = (String) MyCache.getMyCache(getActivity()).readObject(myCachePath + mCurrentPage);
        LogCp.i(LogCp.CP, XRefreshListViewSize10Fragment.class + " 缓存中取出，  列表 数据  " + cacheStr);
...
//            parseList(cacheStr);
    ...
    public MyResponseHandler responseHandler = new MyResponseHandler() {
        ...
        public void dataSuccess(String res) {
            ...
            LogCp.i(LogCp.CP, XRefreshListViewSize10Fragment.class + "请求来的数据 " + res);
...
//            executeParserTask(responseBytes);
        ...
        public void dataFailuer(int errorNo, String strMsg) {
            ...
            LogCp.i(LogCp.CP, XRefreshListViewSize10Fragment.class + "请求列表数据 的时候，出异常了 ,代码：" + errorNo + "， 描述：" + strMsg);
    ...
    class ParserTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                LogCp.i(LogCp.CP, XRefreshListViewSize10Fragment.class + "解析 出来的数据 的，值 ，，"
                        + mData);

 ...
 */
public class XRefreshListViewFragment10HaiBao<T extends MyEntity> extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    ...
    protected void sendRequestData(boolean refresh) {
        ...
        LogCp.i(LogCp.CP, XRefreshListViewFragment10HaiBao.class + "  设置缓存的ke   " + myCachePath);
...
//        LogCp.i(LogCp.CP, XRefreshListViewFragment.class + " 缓存中取出，  列表 数据  " + cacheStr);
    ...
    public MyResponseHandler responseHandler = new MyResponseHandler() {
        ...
        public void dataFailuer(int errorNo, String strMsg) {
            ...
            LogCp.i(LogCp.CP, XRefreshListViewFragment10HaiBao.class + "请求列表数据 的时候，出异常了 ,代码：" + errorNo + "， 描述：" + strMsg);

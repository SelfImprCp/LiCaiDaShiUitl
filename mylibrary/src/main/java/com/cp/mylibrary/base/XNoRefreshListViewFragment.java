...
public class XNoRefreshListViewFragment<T extends MyEntity> extends MyBaseFragment implements    AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
   ...
   // public static final int STATE_REFRESH = 1;
    ...
    protected void sendRequestData(boolean refresh) {
        ...
        LogCp.i(LogCp.CP, XNoRefreshListViewFragment.class + "  设置缓存的ke   " + myCachePath);
...
//        LogCp.i(LogCp.CP, XRefreshListViewFragment.class + " 缓存中取出，  列表 数据  " + cacheStr);
    ...
    public MyResponseHandler responseHandler = new MyResponseHandler() {
        ...
        public void dataFailuer(int errorNo, String strMsg) {
            ...
            LogCp.i(LogCp.CP, XNoRefreshListViewFragment.class + "请求列表数据 的时候，出异常了 ,代码：" + errorNo + "， 描述：" + strMsg);

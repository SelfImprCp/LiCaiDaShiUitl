...
public class XRefreshListViewFenGeActivity<T extends MyEntity> extends MyBaseActivity implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, OnScrollListener {
    ...
    public void setRootView() {
        ...
        setContentView(R.layout.activity_listview_refresh_fenge);
    ...
    public void initView() {
        ...
        addFooterView();
         ...
         LogCp.i(LogCp.CP,XRefreshListViewFenGeActivity.class + " 为空吗？" + mSwipeRefreshLayout);

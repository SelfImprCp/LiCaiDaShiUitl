 ...
 * on 16-6-23.
 */
public abstract class BaseRecyclerViewActivity<T> extends MyBaseActivity implements
    ...
    public void initWidget() {
        ...
        recyclerview_loading = (EmptyLayout)   findViewById(R.id.recyclerview_loading);

        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        LogCp.i(LogCp.CP, BaseRecyclerViewActivity.class + " 是不是null " + mRefreshLayout);
    ...
    public MyResponseHandler mHandler = new MyResponseHandler() {
        ...
        public void dataSuccess(String s) {
            recyclerview_loading.setVisibility(View.GONE);  currentPage++;
        ...
        public void dataFailuer(int i, String s) {
            ...
            LogCp.i(LogCp.CP, BaseRecyclerViewActivity.class + " 接口报错 " + i + s);
        }
    };
    ...
    class ParserTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                LogCp.i(LogCp.CP, BaseRecyclerViewActivity.class + "解析 出来的数据 的，值 ，，"
                        + currentList);

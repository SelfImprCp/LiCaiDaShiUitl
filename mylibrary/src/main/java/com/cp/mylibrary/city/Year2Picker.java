...
// * @author zihao
// */
//public class Year2Picker extends LinearLayout {
//    /**
//     * 滑动控件
//     */
...
//
//    public Year2Picker(Context context, AttributeSet attrs) {
//        super(context, attrs);
...
//    }
//
//    public Year2Picker(Context context) {
//        super(context);
//        this.context = context;
//        getaddressinfo();
//        // TODO Auto-generated constructor stub
...
//
//
//        String area_str = FileAreaUtil.readAssets(context, "licaishi_year2.json");
//        province_list = parser.getJSONParserResult(area_str, "hang0");
//
//
//
//        LogCp.i(LogCp.CP, Year2Picker.class + "解析了多少省：" + province_list.size() );
//
//
//    }
//
...
////
////        LogCp.i(LogCp.CP, Year2Picker.class + "市有多少" + citycodeUtil

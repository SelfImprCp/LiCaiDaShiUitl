...
//
        ...
        Music music0 = new Music(1000, "第一首哥", "http://up.mcyt.net/down/45840.mp3", 215000);
        Music music1 = new Music(1001, "第二首哥", "http://vodzjxunrdq.vod.126.net/vodzjxunrdq/43cef8d4-5a08-4e94-aa8b-c7dbd1226347.mp3", 100000);
...
//    }
    ...
    public void play(int position) {
        ...
        LogCp.i(LogCp.CP, AudioPlayer.class + "  哪一条  " + position);

        setPlayPosition(position);
        Music music = getPlayMusic();
        LogCp.i(LogCp.CP, AudioPlayer.class + " 播放的 音乐 " + music.getTitle());

        try {
            mediaPlayer.reset();
            LogCp.i(LogCp.CP, AudioPlayer.class + " 播放的路径" + music.getPath());
            ...
            e.printStackTrace();
            ShowToastUtil.showToast(context, "当前歌曲无法播放");
        }
    }
